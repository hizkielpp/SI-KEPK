...
@section('content')
    ...
    <div class="bg-white border border-gray-200 rounded-md ">
        ...
        <div
            ...
            <a href="{{ route('proposal.create') }}" class="btn-blue" type="button">
                    ...
                    <tr>
                        ...
                        <td class="px-3 !py-4 align-top text-slate-900 leading-7 bg-white border-b border-gray-200">
                            <div class="flex items-center gap-2">
                                <a href="" data-tooltip-target="tooltip-detail" class="icon-white">
                                ...
                                <a href="" data-tooltip-target="tooltip-edit" class="icon-blue">
                                ...
                                <form method="post">
                                    ...
                                    <button type="button" data-tooltip-target="tooltip-delete"
                                        onclick="confirmDelete('ID')" class="icon-red">
